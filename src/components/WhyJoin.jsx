export const WhyJoin = ()=> <section
className="bg-white dark:bg-gray-900 px-4 py-20 border-t border-gray-100 dark:border-gray-800">
  <div className="max-w-6xl mx-auto">
    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-900 dark:text-white mb-4">
      Why Join Ferdinand Global?
    </h2>
    <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 mb-16 text-center max-w-2xl mx-auto">
      We're not just building a business — we're building a movement. Here's what makes us different in the 21st century economy.
    </p>
